...
public class TileManager {
	...
	public TileManager(GamePanel gp) {
		...
		getTileImage();
		loadMap("/maps/16by12map_template.txt");
	}
	...
	public void getTileImage() {
		try {
			...
			tile[3] = new Tile();
			tile[3].image = ImageIO.read(getClass().getResourceAsStream("/tiles/apple_tree1.png"));
			
			tile[4] = new Tile();
			tile[4].image = ImageIO.read(getClass().getResourceAsStream("/tiles/apple_tree2.png"));
